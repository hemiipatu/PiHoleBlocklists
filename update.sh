...
cat /etc/pihole/custom-adlists.list <(wget -qO - https://raw.githubusercontent.com/hemiipatu/PiHoleBlocklists/master/blocklists-update/ultimate-list.txt 2> /dev/null) | sudo tee /etc/pihole/custom-adlists.list
